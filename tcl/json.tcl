...
ad_proc -public json::json2dict {
    -txt
} {
    return [_json2dict]
}

ad_proc -public json::_json2dict {{txtvar txt}} {
    upvar 1 $txtvar txt
...
ad_proc -public json::dict2json {dictVal} {
...
ad_proc -public json::list2json {listVal} {
    return "\[$[join $listVal ,]\]"
}

ad_proc -public json::string2json {str} {
    return "\"$str\""
}
