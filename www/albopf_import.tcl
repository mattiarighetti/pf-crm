...
with_catch errmsg {
    exec wget -q -P /tmp/ https://www.albopf.it/XXDomain/AlboStatico/html/sezioneI.zip 
    ns_log notice Scaricato 1
} {
...
with_catch errmsg {
    exec unzip /tmp/sezioneI.zip
    ns_log notice Scaricato 2
} {
