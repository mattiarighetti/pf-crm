...
ad_form -name indirizzo \
	...
	{cap:text
	    {label "Indirizzo"}
	    {html {size "70" maxlength "100" placeholder "Via Torino, 3, Milano, 20120, Italia"}}
	}
	...
	"SELECT i.via||' '||c.denominazione||', '||i.cap as indirizzo, tipo_id FROM crm_indirizzi i, comuni c WHERE c.comune_id = i.comune_id and indirizzo_id = :indirizzo_id"
    } -new_data {
